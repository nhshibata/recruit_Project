...
void CGameCentipedeMarch::Awake() 
{
	...
	/*m_pFade.lock()->SetFunction<CGameCentipedeMarch>(CFadeController::E_FadeState::FADE_OUT_START, FadeFuncPtr, this, true);
...
void* CGameCentipedeMarch::CreateManager(CScene* prev, CScene* next)
{
	...
	// 再帰
	//CSceneManager::Get().SceneChanged(std::bind(&CGameCentipedeMarch::CreateManager, this, std::placeholders::_1, std::placeholders::_2));
	CSceneManager::Get().SceneChanged<CGameCentipedeMarch>(&CGameCentipedeMarch::CreateManager, this);
	return nullptr;
}
//=====================================================
