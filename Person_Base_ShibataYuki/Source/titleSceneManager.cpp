...
//	void Init()
//	{
//		m_pPolygon = GetOwner()->GetComponent<CPolygonRenderer>().lock();
//	}
//	void Update()
//	{
//		Color color = m_pPolygon.lock()->GetColor();
//		if (m_bDir)
//		{
...
//{
//private:
//	std::weak_ptr<CRectTransform> m_pRect;
//	Vector2 m_vVel;				// 移動量
//	Vector2 m_vForce;			// 力
//	float m_fGravity;
//	float m_fMass;
...
//		m_pRect = image->GetRectTransform();
//
//		m_vVel = Vector2(float(rand() % 22 - 10), float((rand() % 26 + 26) * -1));
//		m_vForce = Vector2(0, -0.9f);
//
//		m_vStartPos = m_pRect.lock()->GetPos();
//	}
//	void Update()
//	{
//		Vector2 pos = m_pRect.lock()->GetPos();
...
//			m_pPolygon.lock()->SetColor(Color(value.x, value.y, value.z, 1));
